...
const BUNDLED_LATEST_VERSION = '2.0.22';
const BUNDLED_MIN_SUPPORTED_VERSION = '2.0.22';
const BUNDLED_LATEST_VERSION_CODE = 26;
const BUNDLED_MIN_SUPPORTED_VERSION_CODE = 26;
