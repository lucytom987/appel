...
const BUNDLED_LATEST_VERSION = '2.0.21';
const BUNDLED_MIN_SUPPORTED_VERSION = '2.0.21';
const BUNDLED_LATEST_VERSION_CODE = 25;
const BUNDLED_MIN_SUPPORTED_VERSION_CODE = 25;
